...
const IMG_INTRO = Path.join(FOLDER, "WhatsApp Image 2026-07-19 at 9.18.49 PM (2).jpeg");
const IMG_FAITH = Path.join(FOLDER, "WhatsApp Image 2026-07-19 at 9.18.50 PM (1).jpeg");
const IMG_KIDS = Path.join(FOLDER, "WhatsApp Image 2026-07-19 at 9.18.49 PM.jpeg");
const IMG_PARTNERS = Path.join(FOLDER, "WhatsApp Image 2026-07-19 at 9.18.50 PM (7).jpeg");
const IMG_MISSION = Path.join(FOLDER, "WhatsApp Image 2026-07-19 at 9.18.50 PM (8).jpeg");
const IMG_TESTIMONY = Path.join(FOLDER, "WhatsApp Image 2026-07-19 at 9.18.50 PM (5).jpeg");
const IMG_CHURCH = Path.join(FOLDER, "WhatsApp Image 2026-07-19 at 9.18.50 PM (3).jpeg");
...
async function prepareAndRender() {
  console.log("Pre-compositing slides for lightning fast encoding...");
  ...
  for (let i = 0; i < SLIDES.length; i++) {
    const s = SLIDES[i];
    const out16x9 = `C:\\Users\\TOLAN\\Music\\cioclub_awards\\scratch\\slide_16x9_${i}.jpg`;
    const out9x16 = `C:\\Users\\TOLAN\\Music\\cioclub_awards\\scratch\\slide_9x16_${i}.jpg`;
  ...
  console.log("Pre-compositing finished! Rendering final videos...");
  ...
  concat16 += `[vcat]drawbox=y=220:color=black@0.42:width=iw:height=640:t=fill[vbg]; `;
  ...
  console.log("Encoding 16:9 WINNING Video...");
  ...
  concat9 += `[vcat]drawbox=y=540:color=black@0.42:width=iw:height=840:t=fill[vbg]; `;
  ...
  console.log("Encoding 9:16 WINNING Video...");
