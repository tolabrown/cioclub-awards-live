                ...
                fetchOptions: {
                    ...
                    onError: (ctx) => {
                        toast.error("Password Change Failed", {
                            description:
                                ctx.error.message ||
                                "Could not change your password. Please verify your current password and try again.",
                        });
                    },
                    onSuccess: () => {
    ...
    <Card class="shadow-sm">
        <CardHeader>
            <CardTitle class="flex items-center gap-2"
                ><Lock class="size-4" /> Security</CardTitle
            >
            <CardDescription
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <Button
                        ...
                        size="icon"
                    >
                        {#if showPassword}<Eye class="size-4" />{:else}<EyeOff
                                class="size-4"
                            />{/if}
                    </Button>
                </div>
