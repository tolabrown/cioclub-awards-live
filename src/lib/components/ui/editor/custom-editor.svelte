...
{#if mounted}
	<Composer {initialConfig} bind:this={composer}>
		<div
			class={cn(
				'editor-shell svelte-lexical w-full overflow-auto',
		...
		>
			...
			<div
				class={cn('editor-container relative', '!border-muted-foreground/20 !bg-background !text-foreground')}
			>
