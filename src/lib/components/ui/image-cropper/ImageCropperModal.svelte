<script lang="ts">
  ...
  $effect(() => {
    if (imageFile) {
      // Trigger the upload by creating a fake file input event
...
>
  <ImageCropper.Dialog class="max-w-4xl">
    <div class="space-y-2">
      <!-- Header -->
      <div class="space-y-2">
        <h2 class="text-3xl font-bold tracking-tight">Crop Avatar Image</h2>
      ...
      <!-- Cropper Area with Enhanced Styling -->
      <div
      ...
      >
        ...
        <!-- Pan Instruction -->
        <!-- <div
          class="flex items-center gap-2 rounded-full border bg-muted/50 px-4 py-2"
        >
