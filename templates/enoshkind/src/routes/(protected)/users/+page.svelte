		...
		<Table.Root>
			...
			<Table.Body>
				{#if loading}
					{#each Array(5) as _}
						<Table.Row class="animate-pulse">
							...
							<Table.Cell class="py-4 col-span-3">
				...
				{:else if filteredUsers.length === 0}
					<Table.Row>
						<Table.Cell class="h-48 text-center text-muted-foreground font-medium col-span-4">
								...
								<DropdownMenu.Root>
									<DropdownMenu.Trigger>
										<Button
											variant="ghost"
											size="icon"
											class="w-8 hover:bg-primary/10 text-muted-foreground hover:text-primary"
										>
