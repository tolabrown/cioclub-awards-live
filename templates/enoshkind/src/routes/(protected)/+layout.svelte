...
<Sidebar.Provider>
	<AppSidebar />
	<Sidebar.Inset
		class="dark:bg-linear-to-br dark:from-primary/10 dark:via-background dark:to-primary/5"
	>
		<header
			class="sticky top-0 left-0 z-50 flex h-16 shrink-0 items-center justify-between gap-2 backdrop-blur-xs transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12"
		>
		...
		<div class="flex flex-1 flex-col gap-4 py-0 px-4 md:px-6 lg:px-8 animate-in">
