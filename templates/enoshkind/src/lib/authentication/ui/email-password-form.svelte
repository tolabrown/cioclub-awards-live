	...
	<div class="grid gap-2">
		...
		<div class="relative w-full">
			<Input
				...
				required
				disabled={isLoading}
				class={cn(errors.password && 'border-destructive pr-10 focus-visible:ring-destructive')}
...
<div class="text-center text-sm">
	...
	<a
		...
		class="rounded underline underline-offset-4 hover:no-underline focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none"
		tabindex={isLoading ? -1 : 0}
	>
		Register
	</a>
