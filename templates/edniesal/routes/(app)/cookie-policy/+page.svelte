    ...
    <div class="container mx-auto px-4">
      <div class="grid lg:grid-cols-12 gap-8">
        ...
        <aside class="lg:col-span-4">
          <div class="sticky top-32 space-y-4">
            ...
            >
              ...
              >
                Questions about our cookie usage or preferences?
              </p>
              <Button
                variant="secondary"
                class="w-full h-12 rounded-xl font-bold uppercase text-xs tracking-widest relative z-10 gap-3"
                href="/contact"
              >
                Contact Us
                <Mail class="size-4" />
        ...
        <div class="lg:col-span-8 space-y-16 max-w-3xl">
          {#each sections as section}
            {@const Icon = icons[section.icon] || Cookie}
