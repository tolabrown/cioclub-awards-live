  ...
  <Drawer.Content class="max-h-[90vh]">
    <Drawer.Header class="border-b">
      <div class="flex items-center gap-3">
        ...
        {/if}
        <div>
          <Drawer.Title class="text-xl">{child.name}</Drawer.Title>
          <Drawer.Description>
            {age !== null
    ...
    <div class="space-y-4 overflow-y-auto p-4">
        ...
        {#if child.gender}
          <div class="flex items-start gap-3">
            <div class="h-5 w-5 flex items-center justify-center mt-0.5">
              <span class="text-lg">{child.gender === "boy" ? "👦" : "👧"}</span
              >
            </div>
            <div>
              ...
              <Badge
                class={cn(
                  child.gender === "boy" ? "bg-blue-500" : "bg-pink-500",
              ...
              <div class="rounded-md bg-muted/50 p-3">
                ...
                <div class="mt-2 space-y-1">
                  <div class="flex flex-col gap-2">
                    <Button href="tel:{parent.phone}" variant="outline">
                      <Phone class="size-4" />
                      {parent.phone}
                    </Button>
                    <Button
                  ...
                  {#if parent.email}
                    <Button href="mailto:{parent.email}" variant="outline">
                      <Mail class="size-4" />
                      {parent.email}
                    </Button>
                  {/if}
      ...
      {#if child.emergencyContact}
        ...
        >
          ...
          <Button href="tel:{child.emergencyContact}" variant="outline">
            <Phone class="size-4" />
