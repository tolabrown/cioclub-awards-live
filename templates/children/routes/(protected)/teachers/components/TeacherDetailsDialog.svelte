  ...
  <Dialog.Content class="max-w-2xl max-h-[90vh] overflow-y-auto">
    <Dialog.Header>
      <div class="flex items-center gap-4">
        ...
        {/if}
        <div>
          <Dialog.Title class="text-2xl">{teacher.name}</Dialog.Title>
          <Dialog.Description>
    ...
    <div class="space-y-6 py-4">
      ...
      <div class="flex flex-wrap gap-2">
        {#if teacher.teacherType}
          <Badge
            class={`${getTypeColor(teacher.teacherType)} text-white px-3 py-1`}
          >
            {teacher.teacherType}
          </Badge>
        {/if}
        {#if teacher.location}
          <Badge
            class={`${getLocationColor(teacher.location)} text-white px-3 py-1`}
          >
            {teacher.location}
          </Badge>
        {/if}
      ...
      <div class="space-y-4">
        ...
        {#if teacher.birthDay}
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
              ...
              <p class="text-muted-foreground">{teacher.birthDay}</p>
            </div>
          </div>
        {/if}
        ...
        {#if teacher.assignedClass}
          <div class="flex items-start gap-3">
            <Briefcase class="mt-1 h-5 w-5 text-muted-foreground" />
            <div class="flex-1">
              <p class="font-medium">Assigned Class</p>
              <p class="text-muted-foreground">{teacher.assignedClass}</p>
            </div>
          </div>
        {/if}
        ...
        {#if capacityList.length > 0}
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
              <p class="font-medium">Age Group Capacity</p>
        ...
        {#if teacher.note}
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
              ...
              <p class="text-muted-foreground whitespace-pre-wrap mt-1">
                {teacher.note}
              </p>
            </div>
          </div>
