<script lang="ts">
	...
	import { Calendar, UserIcon } from '@lucide/svelte';
	...
	const me = getContext('me') as User;
...
<Dialog {open} onOpenChange={handleOpenChange}>
	<DialogContent class="sm:max-w-md">
		<DialogHeader>
			...
			<DialogDescription>Update the academic user details.</DialogDescription>
		</DialogHeader>
