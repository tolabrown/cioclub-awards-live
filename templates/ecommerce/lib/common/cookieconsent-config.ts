    ...
    translations: {
      en: {
        consentModal: {
          ...
          description:
            `We use cookies to enhance your shopping experience on ${SITE_NAME}. By continuing to browse, you agree to our use of cookies.`,
            ...
            },
            {
              ...
              cookieTable: {
                ...
                body: [
                  {
                    name: '_ga',
                    domain: 'laniastores.toolsntuts.com',
