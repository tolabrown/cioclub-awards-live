...
<form {onsubmit} class="grid gap-3">
	...
	<div class="grid gap-2">
		<div class="flex w-full items-center justify-between">
			...
			<Button
				href="/forget-password?redirectTo={encodeURIComponent(
					getRedirectUrl(),
				)}"
...
<div class="flex items-center justify-end gap-4">
	<div class="text-right text-sm">
		...
		<a
			href="/register?redirectTo={encodeURIComponent(getRedirectUrl())}"
			class="underline underline-offset-4 hover:no-underline">Register</a
		>
	</div>
</div>
